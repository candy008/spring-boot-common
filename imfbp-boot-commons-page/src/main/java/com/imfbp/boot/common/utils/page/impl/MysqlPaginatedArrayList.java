 ...
 * @param <T>
 */
public class MysqlPaginatedArrayList<T> extends AbstractPaginatedList<T>{
	...
	public MysqlPaginatedArrayList(){
		super();
	}
	
	public MysqlPaginatedArrayList(int index, int pageSize) {
		super(index,pageSize);
	}
	
	public MysqlPaginatedArrayList(BaseQuery baseQuery,int totalItem) {
